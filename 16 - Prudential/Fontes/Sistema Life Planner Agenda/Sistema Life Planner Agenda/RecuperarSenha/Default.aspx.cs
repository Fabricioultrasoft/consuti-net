...
namespace Sistema_Life_Planner_Agenda.RecuperarSenha
{
    public partial class Default : PageBase
    {
        ...
        {
            string senhaRecuperada = new UsuarioBD().RecuperarSenha(email); 
            //Validar Email para Recuperar Senha

            if (!senhaRecuperada.Equals(string.Empty))
            {
                EnviaEmail(
                    "SisLPA",
                    "naoresponda@sislpa.com.br",
                    email,
                    string.Empty,
                    ...
                    "<br /> Sistema Life Planner Agenda",
                    string.Empty);                    
