    ...
    public class Extras
    {
        ...
        public bool EnviaRespostaAutomatica(string emailDestinatario, string caminhoAnexo)
        {
            ...
            string conteudoMensagem = "<br /><p class=MsoNormal>A <b style='mso-bidi-font-weight:normal'><span style='color:#1F497D;mso-themecolor:text2'>Pousada Zumbzeira</span></b> agradece sua consulta.</p>" +
                        ...
                        "normal'><span style='color:#1F497D;mso-themecolor:text2'>Preços<o:p></o:p></span></b></p><p class=MsoNormal style='text-align:justify;text-indent:1.0cm'><u><span style='color:#4F6228;mso-themecolor:accent3;mso-themeshade:128'>Refeições<o:p></o:p></span></u></p><p class=MsoNormal style='text-align:justify;text-indent:1.0cm'>" +
