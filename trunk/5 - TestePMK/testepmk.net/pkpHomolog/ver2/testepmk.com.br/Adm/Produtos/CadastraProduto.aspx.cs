    ...
    public partial class CadastraProduto : System.Web.UI.Page
    {
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            if (txbNomeProd.Text != "")
            {
                ...
                {
                    caminhoMiniatura = "~\\Adm\\Produtos\\ImgsProdutos\\" + lbImgs.Items[0].Text;
                }
                else
                {
        ...
        protected void imgBtnAdd_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (resultValidacao == "")
                {
                    lbImgs.Items.Add(txbNomeProd.Text + "_" + (lbImgs.Items.Count + 1) + ".jpg");
                    afuImg.Dispose();
                }
                else
                {
        ...
        /// <summary>
        /// Exclui imagens  da lista de imagens adicionadas
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
