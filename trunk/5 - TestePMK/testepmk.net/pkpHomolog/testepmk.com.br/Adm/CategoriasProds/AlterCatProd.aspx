<%@ Page Title="Teste PMK - Adm Categorias" Language="C#" MasterPageFile="~/Adm/AdmMaster.Master" AutoEventWireup="true" CodeBehind="AlterCatProd.aspx.cs" Inherits="testePMK.com.br.Adm.CategoriasProds.AlterCatProd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 <div class="subTitulo">
        Alterar/Excluir Categoria de Produto<br />
        <asp:Panel ID="pnlSelecione" runat="server" Height="94px">
        ...
        <cc1:RoundedCornersExtender ID="pnlSelecione_RoundedCornersExtender" 
            runat="server" BorderColor="Green" Enabled="True" 
            TargetControlID="pnlSelecione">
        </cc1:RoundedCornersExtender>
        <br />
        <asp:Panel ID="pnlCont" runat="server">
            <br />
            <div style="margin-left: 30px; text-align: left;">
                Preencha os campos abaixo para alterar uma categoria de produto.<br />
                <br />
                <br />
                Nome da Categoria:
            ...
            <div style="text-align: center">
                ...
                <asp:Button ID="btnExcluir" runat="server" onclick="btnExcluir_Click" 
                    Text="Excluir" Width="107px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnCancelar" runat="server" onclick="btnZerabann_Click" 
                    Text="Cancelar" CausesValidation="False" Width="107px" />
            </div>
            <br />
        </asp:Panel>
