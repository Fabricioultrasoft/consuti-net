...
namespace CursosTI
{
    public partial class Contato : System.Web.UI.Page
    {
        ...
        protected void LimparButton_Click(object sender, EventArgs e)
        {
            ...
            name.Text =
            message.Text =
            TelefoneTextBox1.Text = 
            DDDTelefoneTextBox1.Text = 
            string.Empty;
        }

        protected void EnviaraButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    EnviaEmail(
                        ...
                        "Contato CursosTI - Enviado pelo site",
                        email.Text + "; Telefone: (" + DDDTelefoneTextBox1.Text + ") " + TelefoneTextBox1.Text + "; Mensagem: " + message.Text,
                        string.Empty);
