<%@ Page Title="" Language="C#" MasterPageFile="~/Adm/Interna.Master" AutoEventWireup="true"
    CodeBehind="ViagensAdm.aspx.cs" Inherits="NovosAres.Adm.ViagensAdm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:Button ID="btnCadastrarDestino" runat="server" Text="Cadastrar" OnClick="BtnCadastrarDestino_Click" />
</asp:Content>
