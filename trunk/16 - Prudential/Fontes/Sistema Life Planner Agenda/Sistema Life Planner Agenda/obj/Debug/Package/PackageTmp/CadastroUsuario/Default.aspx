                ...
                <fieldset>
                    ...
                    <table class="Formulario" >
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="confirmaEmailTextBox" runat="server" Width="300px" TabIndex="2" MaxLength="100"></asp:TextBox>
                                &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" 
                                    ControlToCompare="emailTextBox" ControlToValidate="confirmaEmailTextBox" 
                                    Display="Dynamic" ErrorMessage="*" ToolTip="E-mail não confere!"></asp:CompareValidator>
                                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                    ControlToValidate="confirmaEmailTextBox" ErrorMessage="*" 
                                    ToolTip="Campo Obrigatório!"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="senhaTextBox" runat="server" Width="100px" TabIndex="3" MaxLength="50" TextMode="Password"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="confirmaSenhaTextBox" runat="server" Width="100px" TabIndex="4" MaxLength="50" TextMode="Password"></asp:TextBox>
                    ...
                    <table class="Formulario">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <cc1:FilteredTextBoxExtender ID="telefoneTextBox_FilteredTextBoxExtender" 
                ...
                <fieldset>
                    ...
                    <table class="Formulario" >
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:RegularExpressionValidator ID="EmailTextBoxRegularExpressionValidator0" 
                                    runat="server" ControlToValidate="emailGoogleTextBox" Display="Dynamic" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="SenhaEmailGoogleTextBox" runat="server" Width="100px" TabIndex="8" MaxLength="100" TextMode="Password"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <br />
