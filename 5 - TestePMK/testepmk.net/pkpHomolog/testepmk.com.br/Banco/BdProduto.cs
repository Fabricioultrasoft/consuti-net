    ...
    public class BdProduto
    {
            ...
            string linkVideo)
        {
            ...
            comando.CommandText = "INSERT INTO produto " +
                "(NOME, PRECO_UNIDADE, DESCRICAO, QTD_ESTOQUE, ID_CATEGORIA, PESO, DESCRICAO_COMPLETA, CAMINHO_MINIATURA, LINK_VIDEO) " +
                "VALUES (@nomeProd, @preco, @descricaoProd, @qtdEstoque, @idCategoria, @peso, @descricaoProdCompleta, @caminhoMiniatura, @linkVideo);";
            ...
            string linkVideo)
        {
            ...
            comando.CommandText = "UPDATE produto " +
                ...
                "QTD_ESTOQUE = @qtdEstoque, ID_CATEGORIA = @idCategoria, PESO = @peso, DESCRICAO_COMPLETA = @descricaoProdCompleta, LINK_VIDEO = @linkVideo " +
                "WHERE ID = @idProd;";
        ...
        public DataSet ListarTodos()
        {
            comando.CommandText = "SELECT ID, NOME, PRECO_UNIDADE, DESCRICAO, " +
                "QTD_ESTOQUE, ID_CATEGORIA, PESO, DESCRICAO_COMPLETA, CAMINHO_MINIATURA, LINK_VIDEO " +
                "FROM produto;";
        ...
        public DataSet ListarTodos(int ordem, string filtro)
        {
            ...
            comando.CommandText = "SELECT P.ID, P.NOME, P.PRECO_UNIDADE, P.CAMINHO_MINIATURA, " +
                "P.DESCRICAO, P.QTD_ESTOQUE, C.NOME AS CATEGORIA, P.PESO, P.DESCRICAO_COMPLETA, P.LINK_VIDEO " +
                "FROM produto P " +
        ...
        public DataSet ListarProduto(int idProd)
        {
            comando.CommandText = "SELECT ID, NOME, PRECO_UNIDADE, CAMINHO_MINIATURA, " +
                "DESCRICAO, QTD_ESTOQUE, ID_CATEGORIA, PESO, DESCRICAO_COMPLETA, LINK_VIDEO " +
        ...
        public DataSet GetDetalhesProduto(int idProd)
        {
            comando.CommandText = "SELECT P.ID, P.NOME, P.PRECO_UNIDADE, P.DESCRICAO, P.CAMINHO_MINIATURA" +
                "P.QTD_ESTOQUE, C.NOME AS CATEGORIA, P.PESO, P.DESCRICAO_COMPLETA, P.LINK_VIDEO " +
               "FROM produto P " +
               "JOIN categoria C ON P.ID_CATEGORIA = C.ID " +
               "WHERE P.ID = @idProd;";
            comando.Parameters.AddWithValue("@idProd", idProd);
