        ...
        <table style="margin: 0px 0px 0px 19px; padding: 0px; width: 100%; border-spacing: 0px; empty-cells: show;">
            <tr>
                ...
                <td>
                    ...
                    <cc1:ValidatorCalloutExtender ID="rfvEmail0_ValidatorCalloutExtender" runat="server"
                        Enabled="True" TargetControlID="rfvEmail">
                    </cc1:ValidatorCalloutExtender>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator" runat="server" ControlToValidate="txbEmail"
