...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlFormCadastro" runat="server" Visible="False" DefaultButton="btnCadastrar">
        ...
        <asp:Panel ID="pnlShare" runat="server" Style="margin-left: 30px" Width="475px">
            ...
            <hr />
            <br />
            Email para contato:*<asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txbEmail"
                Display="None" ErrorMessage="Campo Obrigatório!"></asp:RequiredFieldValidator>
            <cc1:ValidatorCalloutExtender ID="rfvEmail_ValidatorCalloutExtender" runat="server"
                Enabled="True" TargetControlID="rfvEmail" PopupPosition="Left">
            </cc1:ValidatorCalloutExtender>
            <asp:RegularExpressionValidator ID="refEmail" runat="server" ControlToValidate="txbEmail"
                Display="None" ErrorMessage="Formato de email inválido!" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
            <cc1:ValidatorCalloutExtender ID="refEmail_ValidatorCalloutExtender" runat="server"
                Enabled="True" TargetControlID="refEmail" PopupPosition="Left">
            </cc1:ValidatorCalloutExtender>
            <br />
            <asp:TextBox ID="txbEmail" runat="server" CssClass="campoObrigatorio" Width="450px"
                MaxLength="100" TabIndex="18"></asp:TextBox>
            <br />
            Senha para acesso ao site:*<asp:RequiredFieldValidator ID="rfvSenha" runat="server"
