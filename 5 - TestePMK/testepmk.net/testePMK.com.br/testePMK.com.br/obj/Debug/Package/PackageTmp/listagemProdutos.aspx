                ...
                <div>
                    <div id="imgProd" style="width: 160px; height: 200px; float: left">
                        <asp:Image ID="imgBtnFotos" runat="server" ImageUrl='<%# Eval("CAMINHO_MINIATURA") %>'
                            AlternateText="Ver imagens deste produto" Width="150px" Height="160px"></asp:Image>
                        <br />
                        <div style="text-align: center">
                            ...
                            <div id="linkVideo">
                                ...
                                <asp:LinkButton ID="imgBtnLinkVIdeo" runat="server" Font-Size="XX-Small" CommandArgument='<%# Bind("ID") %>'
                                    CommandName="verVideo" AlternateText="Vídeo do produto">
                                <asp:Image ID="Image1" runat="server" ImageAlign="Middle" ImageUrl="~/Graficos/YouTube.png" /></asp:LinkButton>
                            </div>
                            <br />
                        </div>
                        <div class="PrecoProduto">
                            ...
                            +
                            <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="XX-Small" CommandArgument='Sedex'
                                CommandName="Sedex" AlternateText="Simulador Sedex">
                                <asp:Image ID="imgBtnSedex" runat="server"  AlternateText="Simulador Sedex" ImageUrl="~/Graficos/SedexCobrar.gif"
                    ...
                    <div id="item">
                        ...
                        -->
                            ...
                            <input type="hidden" name="item_valor" value="<%# Eval("PRECO_INT") %>" />
