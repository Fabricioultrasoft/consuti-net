    ...
    <div>
        ...
        <asp:Panel ID="pnlContato" runat="server">
            <div id="formContato">
                ...
                <cc1:MaskedEditExtender ID="txbTelefone_MaskedEditExtender" runat="server" CultureAMPMPlaceholder=""
                    ...
                    Enabled="True" Mask="(99) 9999-9999" MaskType="Number" TargetControlID="txbTelefone"
                ...
                <br />
                <asp:TextBox ID="txbMensagem" runat="server" Height="170px" TextMode="MultiLine"
                    Width="520px" onkeyup="progreso_tecla(this)"></asp:TextBox>
                <br />
                <div id="progresso">
                    (0 / 500)</div>
                <br />
        ...
        <div class="style8">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Efetue suas compras também pelo telefone <strong>0xx
                31 8805-1820, 0xx 31 3586-5607</strong> ou <strong>0xx 31 3586-5609</strong>.
            Esta é mais uma opção para que você efetue suas compras com toda a comodidade sem
            sair de casa.
            <br />
